...
#ifndef _MANGOS_REALM_CONFIG
# define _MANGOS_REALM_CONFIG  "mangosrealm.conf"
#endif

#ifdef _WIN32
#include "ServiceWin32.h"
char serviceName[] = "realmd";
char serviceLongName[] = "MaNGOS realm service";
...
extern int main(int argc, char** argv)
{
    ...
    char const* cfg_file = _MANGOS_REALM_CONFIG;
    ...
    {
        sLog.outError("*****************************************************************************");
        sLog.outError(" WARNING: Your mangosrealm.conf version indicates your conf file is out of date!");
