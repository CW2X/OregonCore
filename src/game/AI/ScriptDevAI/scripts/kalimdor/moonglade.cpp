                ...
                if (EventTimer <= diff)
                {
                    ...
                    case 6:
                        if (HealthBelowPct(20))
                        {
                            ...
                            {
                                CAST_AI(npc_remulos::npc_remulosAI, pRemulos->AI())->EranikusPhase = false;
                                CAST_AI(npc_remulos::npc_remulosAI, pRemulos->AI())->uiPhase = 0;
                                CAST_AI(npc_remulos::npc_remulosAI, pRemulos->AI())->SetEscortPaused(false);
                            }
                    ...
                    case 13:
                        if (Creature* pRemulos = Unit::GetCreature(*me, RemulosGUID))
                        {
                            ...
                            CAST_AI(npc_remulos::npc_remulosAI, pRemulos->AI())->EventComplete();
                        }
                        if (Creature* pTyrande = Unit::GetCreature(*me, TyrandeGUID))
                        ...
                        if (Creature* pRemulos = Unit::GetCreature(*me, RemulosGUID))
                        {
                            ...
                            CAST_AI(npc_remulos::npc_remulosAI, pRemulos->AI())->ClearSummonedCreatures();
