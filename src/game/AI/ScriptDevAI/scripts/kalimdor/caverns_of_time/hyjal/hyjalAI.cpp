...
Wave AllianceWaves[18] =                               // Waves that will be summoned in the Alliance Base
{
...
Wave HordeWaves[18] =                                  // Waves that are summoned in the Horde base
{
    // Kaz'Rogal Wave 1-8
