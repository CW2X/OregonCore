...
{
public:
    npc_highlord_demitrain() : CreatureScript("npc_highlord_demitrain") {}
...
public:
    ...
    bool OnGossipSelect(Player* pPlayer, Creature* pCreature, uint32 /*uiSender*/, uint32 uiAction)
    {
        ...
        case GOSSIP_ACTION_INFO_DEF + 9:
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_ITEM11, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 10);
...
# npc_anachronos_the_ancient
######*/
class npc_anachronos_the_ancient : CreatureScript
{
public:
...
void AddSC_silithus()
{
    new npc_highlord_demitrain();
    new npcs_rutgar_and_frankal();
    new npc_scout_landion();
