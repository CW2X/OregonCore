...
public: 
    ...
    struct npc_commander_dawnforgeAI : public ScriptedAI
    {
        ...
        Creature* SelectCreatureInGrid(uint32 entry, float range)
        {
            ...
            MaNGOS::NearestCreatureEntryWithLiveStateInObjectRangeCheck creature_check(*me, entry, true, range);
...
class npc_mana_wraith : public CreatureScript
{
public: 
    npc_mana_wraith() : CreatureScript("npc_mana_wraith") { }
...
class npc_warp_abberation : public CreatureScript
{
public: 
    npc_warp_abberation() : CreatureScript("npc_warp_abberation") { }
...
class npc_mana_seeker : public CreatureScript
{
public: 
    npc_mana_seeker() : CreatureScript("npc_mana_seeker") { }
...
class npc_mageslayer : public CreatureScript
{
public: 
    npc_mageslayer() : CreatureScript("npc_mageslayer") { }
...
class npc_naberius : public CreatureScript
{
public: 
    npc_naberius() : CreatureScript("npc_naberius") { }
...
class npc_doctor_vomisa : public CreatureScript
{
public: 
    npc_doctor_vomisa() : CreatureScript("npc_doctor_vomisa") { }
...
class npc_talbuk_doe : public CreatureScript
{
public: 
    npc_talbuk_doe() : CreatureScript("npc_talbuk_doe") { }
...
class npc_talbuk_sire : public CreatureScript
{
public: 
    npc_talbuk_sire() : CreatureScript("npc_talbuk_sire") { }
...
class npc_warp_monstrosity : public CreatureScript
{
public: 
    npc_warp_monstrosity() : CreatureScript("npc_warp_monstrosity") { }
...
class npc_inactive_fel_reaver : public CreatureScript
{
public: 
...
class gehenna_trigger : public CreatureScript
{
public: 
    gehenna_trigger() : CreatureScript("gehenna_trigger") { }
...
{
public: 
    legion_aldor_trigger() : CreatureScript("legion_aldor_trigger") { }
...
{
public: 
    adyen_lightwarden() : CreatureScript("adyen_lightwarden") { }
    struct adyen_lightwardenAI : public ScriptedAI
    {
    	...
    	void SocretharEvent()
    	{
    		...
    		{
    			CAST_AI(npc_socrethar::npc_socretharAI, socrethar->AI())->EventStarted = true;
    			CAST_AI(npc_socrethar::npc_socretharAI, socrethar->AI())->wait_timer = 15000;
    		}
    	}
    	...
    	void SocretharEvent1()
    	{
    		if (Creature* socrethar = me->FindNearestCreature(NPC_SOCRETHAR, 25.0f, true))
    		{
    			CAST_AI(npc_socrethar::npc_socretharAI, socrethar->AI())->wait_timer1 = 12000;
    		}
    	}
...
class npc_kaylaan : public CreatureScript
{
public: 
    npc_kaylaan() : CreatureScript("npc_kaylaan") { }
    struct npc_kaylaanAI : public ScriptedAI
    {
    	...
    	void SocretharCombatMe()
    	{
    		...
    		{
    			CAST_AI(npc_socrethar::npc_socretharAI, socrethar->AI())->combat_timer = 10000;
    		}
    	}
    	...
    	void SocretharStopMe()
    	{
    		if (Creature* socrethar = me->FindNearestCreature(NPC_SOCRETHAR, 60.0f, true))
    		{
    			CAST_AI(npc_socrethar::npc_socretharAI, socrethar->AI())->combat_timer1 = 3000;
    		}
    	}
...
class npc_socre_helper : public CreatureScript
{
public: 
    npc_socre_helper() : CreatureScript("npc_socre_helper") { }
    	...
    	void UpdateAI(const uint32 diff)
    	{
    		if (!UpdateVictim())
    		{
    			if (!SocStart)
    			{
    				...
    				{
    					CAST_AI(npc_kaylaan::npc_kaylaanAI, kaylaan->AI())->CombatEnd = true;
    				}
    			}
    		}
    	}
...
class legion_beam_trigger : public CreatureScript
{
public: 
    legion_beam_trigger() : CreatureScript("legion_beam_trigger") { }
...
class arena_event_controller : public CreatureScript
{
public: 
    arena_event_controller() : CreatureScript("arena_event_controller") { }
...
class npc_windtrader_marid : public CreatureScript
{
public: 
    npc_windtrader_marid() : CreatureScript("npc_windtrader_marid") { }
...
{
public: 
    npc_captured_protectorate() : CreatureScript("npc_captured_protectorate") { }
...
{
public: 
    npc_energy_ball() : CreatureScript("npc_energy_ball") { }
    		...
    		if (!UpdateVictim())
    		{
    			if (!object_found)
    			{
    				...
    				{					
    					...
    					if (Creature* salahaad = me->FindNearestCreature(20454, 100.0f, true))
    					{
    						CAST_AI(npc_salhadaar::npc_salhadaarAI, salahaad->AI())->Activate();
    					}
    				}
    			}			
...
class npc_dimensius_devourer : public CreatureScript
{
public: 
    npc_dimensius_devourer() : CreatureScript("npc_dimensius_devourer") { }
...
class npc_commander_ameer : public CreatureScript
{
public: 
    npc_commander_ameer() : CreatureScript("npc_commander_ameer") { }
...
class npc_reflection_of_ya_six : public CreatureScript
{
public: 
    npc_reflection_of_ya_six() : CreatureScript("npc_reflection_of_ya_six") { }
...
public:
	...
	bool OnGossipHello(Player* player, GameObject* _GO) override
	{
		...
		if (manaforge)
		{
			...
			((npc_manaforge_control_console::npc_manaforge_control_consoleAI*)manaforge->AI())->goConsole = _GO->GetGUID();
...
void AddSC_netherstorm()
{
    ...
    new npc_drijya();
    new npc_mana_wraith();
    new npc_warp_abberation();
    new npc_scrapped_fel_reaver();
    new npc_mana_seeker();
    new npc_mageslayer();
    new npc_naberius();
    new npc_doctor_vomisa();
    new npc_negatron();
    new npc_farahlon_lasher();
    new npc_talbuk_doe();
    new npc_talbuk_sire();
    new npc_warp_monstrosity();
    new npc_inactive_fel_reaver();
    new gehenna_trigger();
    new legion_aldor_trigger();
    new adyen_lightwarden();
    new npc_socrethar();
    new npc_kaylaan();
    new npc_socre_helper();
    new legion_beam_trigger();
    new arena_event_controller();
    new npc_windtrader_marid();
    new npc_captured_protectorate();
    new npc_protectorate_demolitionist();
    new npc_energy_ball();
    new npc_salhadaar();
    new npc_captain_saeed();
    new npc_dimensius_devourer();
    new npc_commander_ameer();
    new npc_reflection_of_ya_six();
