...
public: 
    ...
    bool OnGossipHello(Player* pPlayer, GameObject* pGo) override
    {
        ...
        {
            if (npc_mana_bomb_exp_trigger::npc_mana_bomb_exp_triggerAI* pBombAI = dynamic_cast<npc_mana_bomb_exp_trigger::npc_mana_bomb_exp_triggerAI*>(pCreature->AI()))
...
class npc_darkscreecher_akarai : public CreatureScript
{
public: 
    npc_darkscreecher_akarai() : CreatureScript("npc_darkscreecher_akarai") { }
...
{
public: 
    npc_private_weeks() : CreatureScript("npc_private_weeks") { }
...
class npc_scout_nefris : public CreatureScript
{
public: 
    npc_scout_nefris() : CreatureScript("npc_scout_nefris") { }
...
class npc_shadowy_executioner : public CreatureScript
{
public: 
    npc_shadowy_executioner() : CreatureScript("npc_shadowy_executioner") { }
...
class npc_shadowy_laborer : public CreatureScript
{
public: 
    npc_shadowy_laborer() : CreatureScript("npc_shadowy_laborer") { }
...
class npc_shadowy_summoner : public CreatureScript
{
public: 
    npc_shadowy_summoner() : CreatureScript("npc_shadowy_summoner") { }
...
class npc_shadowy_advisor : public CreatureScript
{
public: 
    npc_shadowy_advisor() : CreatureScript("npc_shadowy_advisor") { }
...
class npc_shadowy_initiate : public CreatureScript
{
public: 
    npc_shadowy_initiate() : CreatureScript("npc_shadowy_initiate") { }
...
class npc_pathaleon_image2 : public CreatureScript
{
public: 
    npc_pathaleon_image2() : CreatureScript("npc_pathaleon_image2") { }
...
{
public: 
    npc_voldoun() : CreatureScript("npc_voldoun") { }
...
{
public: 
    mob_mountain_colossus() : CreatureScript("mob_mountain_colossus") { }
...
{
public:
	npc_skyguard_ace() : CreatureScript("npc_skyguard_ace") { }
    ...
    struct npc_terokkAI : public ScriptedAI
    {
    	...
    	void UpdateAI(const uint32 diff)
    	{
    		...
    		if (shielded == true && bombed1 == false && bomb_timer <= diff)
    		{
    			if (Creature* ace = me->FindNearestCreature(NPC_ACE, 150.0f, true))
    			{
    				CAST_AI(npc_skyguard_ace::npc_skyguard_aceAI, me->AI())->Bombing();
    				bombed1 = true;
    			}
    		}
...
class npc_kalliri_trigger : public CreatureScript
{
public: 
    npc_kalliri_trigger() : CreatureScript("npc_kalliri_trigger") { }
...
void AddSC_terokkar_forest()
{
    ...
    new npc_darkscreecher_akarai();
    new npc_private_weeks();
    new npc_scout_nefris();
    new npc_shadowy_executioner();
    new npc_shadowy_laborer();
    new npc_shadowy_summoner();
    new npc_shadowy_advisor();
    new npc_shadowy_initiate();
    new npc_empoor();
    new npc_pathaleon_image2();
    new npc_voldoun();
    new mob_mountain_colossus();
    new go_ancient_skull_pile();
    new npc_terokk();
    new npc_skyguard_ace();
    new npc_kalliri_trigger();
