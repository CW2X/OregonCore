...
class npc_grand_commander_ruusk : public CreatureScript
{
public: 
...
class npc_sunfurywarlock : public CreatureScript
{
public: 
    npc_sunfurywarlock() : CreatureScript("npc_sunfurywarlock") { }
...
class legion_infernal_summon_trigger : public CreatureScript
{
public: 
    legion_infernal_summon_trigger() : CreatureScript("legion_infernal_summon_trigger") { }
...
class legion_infernal_summoner_trigger : public CreatureScript
{
public: 
    legion_infernal_summoner_trigger() : CreatureScript("legion_infernal_summoner_trigger") { }
...
class legion_hold_device_trigger : public CreatureScript
{
public: 
    legion_hold_device_trigger() : CreatureScript("legion_hold_device_trigger") { }
...
class npc_deathbringer_jovaan : public CreatureScript
{
public: 
    npc_deathbringer_jovaan() : CreatureScript("npc_deathbringer_jovaan") { }
...
class npc_shadowcouncil_warlock : public CreatureScript
{
public: 
    npc_shadowcouncil_warlock() : CreatureScript("npc_shadowcouncil_warlock") { }
...
class npc_plexi : public CreatureScript
{
public: 
...
class npc_nakansi : public CreatureScript
{
public: 
...
class npc_zuluhed_the_whacked : public CreatureScript
{
public: 
    npc_zuluhed_the_whacked() : CreatureScript("npc_zuluhed_the_whacked") { }
...
class npc_dragonmaw_archer : public CreatureScript
{
public: 
    npc_dragonmaw_archer() : CreatureScript("npc_dragonmaw_archer") { }
...
class npc_shadowmoon_ancient_spirit : public CreatureScript
{
public: 
...
class npc_karsius_the_ancient_watcher : public CreatureScript
{
public: 
    npc_karsius_the_ancient_watcher() : CreatureScript("npc_karsius_the_ancient_watcher") { }
...
class teron_trigger : public CreatureScript
{
public: 
    teron_trigger() : CreatureScript("teron_trigger") { }
...
class teron_gorefiend_event : public CreatureScript
{
public: 
    teron_gorefiend_event() : CreatureScript("teron_gorefiend_event") { }
...
class go_forged_illidari_bane_sword : public GameObjectScript
{
public: 
...
class npc_artor : public CreatureScript
{
public: 
    npc_artor() : CreatureScript("npc_artor") { }
...
class npc_artor_spirit : public CreatureScript
{
public: 
...
class npc_tiny_trigger : public CreatureScript
{
public: 
    npc_tiny_trigger() : CreatureScript("npc_tiny_trigger") { }
...
class npc_painmistress_gabrisa : public CreatureScript
{
public: 
    npc_painmistress_gabrisa() : CreatureScript("npc_painmistress_gabrisa") { }
...
class npc_illidari_shocktrooper : public CreatureScript
{
public: 
    npc_illidari_shocktrooper() : CreatureScript("npc_illidari_shocktrooper") { }
...
class npc_veneratus : public CreatureScript
{
public: 
    npc_veneratus() : CreatureScript("npc_veneratus") { }
...
{
public: 
    npc_envoy_icarius() : CreatureScript("npc_envoy_icarius") { }
    		...
    		if (!UpdateVictim())
    		{
    			if (!ThistleFound)
    			{
    				if (me->FindNearestGameObject(184798, 100.0f))
    				{
    					...
    					{
    						CAST_AI(npc_icarus_trigger::npc_icarus_triggerAI, IcarusTrig->AI())->WhisperAllow = true;
    					}
...
{
public: 
    npc_guldan() : CreatureScript("npc_guldan") { }
...
class npc_oronok : public CreatureScript
{
public: 
    npc_oronok() : CreatureScript("npc_oronok") { }
...
class npc_cyrukh_the_firelord : public CreatureScript
{
public: 
    npc_cyrukh_the_firelord() : CreatureScript("npc_cyrukh_the_firelord") { }
    struct npc_cyrukh_the_firelordAI : public ScriptedAI
    {
    	...
    	{	
    		...
    		{
    			CAST_AI(npc_oronok::npc_oronokAI, oronok->AI())->CyrukhDied = true;
    		}
    	}
...
void AddSC_shadowmoon_valley()
{
    ...
    new npc_grand_commander_ruusk();
    new npc_azaloth();
    new npc_sunfurywarlock();
    new legion_infernal_summon_trigger();
    new legion_infernal_summoner_trigger();
    new legion_hold_device_trigger();
    new npc_deathbringer_jovaan();
    ...
    new teron_trigger();
    new teron_gorefiend_event();
    new go_forged_illidari_bane_sword();
    new npc_artor();
    new npc_artor_spirit();
    new npc_tiny_trigger();
    new npc_painmistress_gabrisa();
    new npc_illidari_shocktrooper();
    new npc_veneratus();
    new npc_envoy_icarius();
    new npc_icarus_trigger();
    new npc_guldan();
    new npc_oronok();
