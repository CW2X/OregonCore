...
public:
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action) override
    {
        ...
        case GOSSIP_ACTION_INFO_DEF + 1:
            ...
            {
                CAST_AI(npc_marshal_windsor::npc_marshal_windsorAI, windsor->AI())->SetEscortPaused(false);
            }
...
public:
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action) override
    {
        ...
        case GOSSIP_ACTION_INFO_DEF + 1:
            ...
            {
                CAST_AI(npc_marshal_reginald_windsor::npc_marshal_reginald_windsorAI, reginald->AI())->SetEscortPaused(false);
            }
...
{
public:
    npc_crest() : CreatureScript("npc_crest") { }
...
class npc_shill : public CreatureScript
{
public:
    npc_shill() : CreatureScript("npc_shill") { }
...
class npc_ograbisi : public CreatureScript
{
public:
    npc_ograbisi() : CreatureScript("npc_ograbisi") { }
...
class npc_jaz : public CreatureScript
{
public:
    npc_jaz() : CreatureScript("npc_jaz") { }
