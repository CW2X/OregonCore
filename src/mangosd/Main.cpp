...
#ifndef _MANGOS_CORE_CONFIG
# define _MANGOS_CORE_CONFIG  "mangoscore.conf"
#endif //_MANGOS_CORE_CONFIG

// Format is YYYYMMDDRR where RR is the change in the conf file
// for that day.
#ifndef _MANGOS_CORE_CONFVER
# define _MANGOS_CORE_CONFVER 2014091557
...
char serviceLongName[] = "MaNGOS core service";
...
extern int main(int argc, char** argv)
{
    ...
    char const* cfg_file = _MANGOS_CORE_CONFIG;
    ...
    if (confVersion < _MANGOS_CORE_CONFVER)
    {
        sLog.outError("*****************************************************************************");
        sLog.outError(" WARNING: Your mangoscore.conf version indicates your conf file is out of date!");
    ...
    // 0 - normal shutdown
    // 1 - shutdown at error
    // 2 - restart command used, this code can be used by restarter for restart MaNGOSCore
}
